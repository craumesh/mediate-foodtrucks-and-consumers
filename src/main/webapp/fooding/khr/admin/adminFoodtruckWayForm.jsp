...
<link href="./fooding/khr/css/adminFoodtruckWayForm.css" rel="stylesheet">
...
<script>
    ...
    function submitContent() {
        ...
        xhr.open('POST', './AdminFoodtruckWayAddProAction.adm', true);
        ...
        xhr.onload = function () {
            if (xhr.status >= 200 && xhr.status < 300) {
                ...
                if (xhr.responseText === "Success") {
                    alert("등록 완료!");
                    location.href="./AdminFoodtruckContent.adm?foodtruck_id="+document.getElementById('foodtruck_id').value;
                } else {
                    // 서버에서 에러 메시지를 전송한 경우
